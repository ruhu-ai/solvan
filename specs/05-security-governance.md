...
| unconnected, substituted, or wrong-region release source | human-authorized regional GitHub App connection, `COMPLETE` connection preflight, Terraform-owned linked repository, exact resource-name/remote-URI verification, no source token in release inputs | `CCR-008` |
